...
% initial_theta = csvread('theta.csv')
...
% Xtick = [ones(size(tick,1),1) tick ones(size(tick,1),1)]
% prob = sigmoid(Xtick * theta);

% fprintf(['For ticker prices, we predict bid/ask ' ...
%          'probability of %f\n'], prob);
