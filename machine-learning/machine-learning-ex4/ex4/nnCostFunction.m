...
for i = 1:m
    ...
    a = [1; a];
    h = sigmoid(Theta2 * a);
    v = zeros(num_labels,1); v(y(i)) = 1;
    J += -v' * log(h)  - (1 - v)' * log(1 - h);
end
...
for t = 1:m
    ...
    v = zeros(num_labels,1); v(y(t)) = 1; % 10x1
    d_3 = a_3 - v;            % 10x1
    d_2 = Theta2' * d_3;      % 26x10 * 10x1 = 26x1
    d_2 = d_2(2:end) .* sigmoidGradient(z_2); % 25x1 .* 25x1
